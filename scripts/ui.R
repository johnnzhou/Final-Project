...
shinyUI(navbarPage(
  ...
  tabPanel(
    ...
    p("In this tab, users can select an input to get the ", 
      strong("top 10 occupations"),"or", 
      strong("bottom 10 occupations based on salary"),". These two datas are shown through 
      bar graphs with the x-axis displaying the different occupations and y-axis
      displaying the salaries." ,br(),br(),
      "Underneath the salary graph, users can select one 
      of the" ,strong("10 most paid salary occupations"), "or", 
      strong("10 least paid salary occupations"),
      "to view the gender differences in the pie charts."
    ),
    sidebarLayout(
      sidebarPanel(
        selectInput("work",
